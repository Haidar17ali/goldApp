...
@section('content_header')
    <h1>Transaksi {{$type}} {{$purchaseType}}</h1>
@stop
...
@section('content')
    <div class="card">
        <div class="card-header">
            ...
            <a href="{{ route('transaksi.buat', ["type"=>$type,"purchaseType" =>$purchaseType]) }}" class="float-right btn btn-primary"><i class="fas fa-plus"></i>
                Transaksi</a>
            <div class="float-left">
                <input type="text" id="searchBox" data-model="transactions" class="float-right mb-3 form-control"
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.pagination a', function(e) {
                ...
                fetchData(inputElement, page, 'transactions');
            });

            $('#searchBox').each(function() {
                fetchData(this, 1, 'transactions');
            });
        });
    </script>
@stop
