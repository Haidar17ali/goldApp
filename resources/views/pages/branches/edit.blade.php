...
@section('content')
    <div class="card">
        <div class="card-header">
            ...
            <div class="float-right badge badge-primary">Ubah Produk</div>
        </div>
    </div>
    <form action="{{ route('cabang.update', $branch->id) }}" method="POST" id="formRP">
        @csrf
        @method('patch')
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <textarea class="form-control" id="exampleFormControlTextarea1" id="address" name="address" rows="3">{{$branch->address}}</textarea>
