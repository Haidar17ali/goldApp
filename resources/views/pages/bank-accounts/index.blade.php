...
@section('content')
    <div class="card">
        <div class="card-header">
            ...
            <a href="{{ route('rekening.buat') }}" class="btn btn-primary float-right"><i class="fas fa-plus"></i>
                Rekening</a>
            <div class="float-left">
                <input type="text" id="searchBox" data-model="bankAccounts" class="form-control mb-3 float-right"
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.pagination a', function(e) {
                ...
                fetchData(inputElement, page, 'bankAccounts');
            });

            $('#searchBox').each(function() {
                fetchData(this, 1, 'bankAccounts');
            });
        });
    </script>
@stop
