...
@section('title', 'Keluar Etalase')

@section('content_header')
    <h1>Keluar Etalase</h1>
@stop
...
@section('content')
    <div class="card">
        <div class="card-header">
            ...
            <a href="{{ route('keluar-etalase.buat') }}" class="float-right btn btn-primary"><i class="fas fa-plus"></i>
                Etalase</a>
            <div class="float-left">
                <input type="text" id="searchBox" data-model="goldMergeConversions" class="float-right mb-3 form-control"
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            fetchData("", 1, "goldMergeConversions");
            ...
            $(document).on('click', '.pagination a', function(e) {
                ...
                fetchData(inputElement, page, 'goldMergeConversions');
            });

            $('#searchBox').each(function() {
                fetchData(this, 1, 'goldMergeConversions');
            });
        });
    </script>
@stop
