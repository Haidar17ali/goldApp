        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" value="{{ $productVariant->sku }}" disabled>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4 d-flex align-items-center">
                        <div class="mr-4 form-check">
                            <input class="form-check-input" type="radio" name="type" id="type_new" value="new"
                                {{ old('type', $productVariant->type) == 'new' ? 'checked' : '' }}>
                            <label class="form-check-label" for="type_new">NEW</label>
                        </div>

                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="type" id="type_sepuh" value="sepuh"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="number" step="0.01" min="0" class="form-control" id="gram"
                            name="gram" value="{{ old('gram', $productVariant->gram) }}" placeholder="Contoh: 1.25">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="number" min="0" class="form-control" id="default_price" name="default_price"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <textarea name="note" id="note" rows="3" class="form-control" placeholder="Catatan tambahan (opsional)">{{ old('note', $productVariant->note) }}</textarea>
                    </div>
                </div>
