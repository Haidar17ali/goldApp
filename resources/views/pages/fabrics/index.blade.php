...
@section('content')
    <div class="card">
        <div class="card-header">
            ...
            <a href="{{ route('kain.buat') }}" class="btn btn-primary float-right"><i class="fas fa-plus"></i>
                Kain</a>
            <div class="float-left">
                <input type="text" id="searchBox" data-model="fabrics" class="form-control mb-3 float-right"
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.pagination a', function(e) {
                ...
                fetchData(inputElement, page, 'fabrics');
            });

            $('#searchBox').each(function() {
                fetchData(this, 1, 'fabrics');
            });
        });
    </script>
@stop
