            ...
            <form id="opnameForm" method="POST" action="{{ route('opname.simpan') }}">
                ...
                <div class="mb-4 row">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control form-control-lg" value="{{ $branch->name ?? '-' }}"
                            readonly>
                    </div>
                    <div class="col-md-4">
                        <label class="fw-semibold">Lokasi Penyimpanan</label>
                        <input type="text" class="form-control form-control-lg" value="{{ $location->name ?? '-' }}"
                            readonly>
                    </div>
                </div>
                        ...
                        <tbody id="opnameTable">
                                ...
                                <tr>
                                    <td>
                                        <select name="details[{{ $i }}][product_id]"
                                            ...
                                            @foreach ($products as $p)
                                                <option value="{{ $p->id }}"
                                                    {{ $p->id == $stock->product_id ? 'selected' : '' }}>
                                                    {{ $p->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <td>
                                        <select name="details[{{ $i }}][gold_type]"
                                            ...
                                            <option value="new" {{ $stock->type == 'new' ? 'selected' : '' }}>New
                                            </option>
                                            <option value="sepuh" {{ $stock->type == 'sepuh' ? 'selected' : '' }}>Sepuh
                                            </option>
                                            <option value="rosok" {{ $stock->type == 'rosok' ? 'selected' : '' }}>Rosok
                                            </option>
                                        </select>
                                    </td>
                                    ...
                                    <td>
                                        <input type="number" step="0.001"
                                            name="details[{{ $i }}][system_qty]"
                                            class="form-control form-control-lg text-end" value="{{ $stock->quantity }}"
                                            readonly>
                                    </td>
                                    ...
                                    <td>
                                        <input type="number" step="0.001"
                                            ...
                                            class="form-control form-control-lg text-end actual-qty"
                                            value="{{ $stock->quantity }}">
                                    </td>

                                    <td class="text-end difference">0</td>
                                    <td class="text-center">
                                        <button type="button" class="btn btn-danger btn-lg removeRow"><i
                            ...
                            @empty
                                <tr>
                                    ...
                                    <td>
                                        <select name="details[0][karat_id]"
                                            class="form-control form-control-lg select-karat" required>
                                            <option value="">-- Pilih Karat --</option>
                                            @foreach ($karats as $k)
                                    ...
                                    <td>
                                        <select name="details[0][gold_type]"
                                            class="form-control form-control-lg select-goldtype" required>
                                    ...
                                    <td>
                                        <input type="number" name="details[0][system_qty]"
                                    ...
                                    <td class="text-end difference">0</td>
                                    <td class="text-center">
                                        <button type="button" class="btn btn-success btn-lg addRow"><i
