...
@section('title', 'Data Customer Suppplier')
...
@section('content')
    <div class="card">
        <div class="card-header">
            ...
            <a href="{{ route('customer-supplier.buat', $type) }}" class="btn btn-primary float-right"><i
                    class="fas fa-plus"></i>
                {{ $type }}</a>
            <div class="float-left">
                <input type="text" id="searchBox" data-model="customerSuppliers" class="form-control mb-3 float-right"
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.pagination a', function(e) {
                ...
                fetchData(inputElement, page, 'customerSuppliers');
            });

            $('#searchBox').each(function() {
                fetchData(this, 1, 'customerSuppliers');
            });
        });
    </script>
@stop
