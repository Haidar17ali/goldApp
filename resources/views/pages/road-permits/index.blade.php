    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="float-left">
                <input type="text" id="searchBox" data-model="road_permits" class="form-control mb-3 float-right"
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.pagination a', function(e) {
                ...
                fetchData(inputElement, page, 'road_permits');
            });
