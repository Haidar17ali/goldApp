...
@section('content')
    <div class="card">
        <div class="card-header">
            ...
            <a href="{{ route('rotari.buat', $type) }}" class="btn btn-primary float-right"><i class="fas fa-plus"></i>
                {{ $type }}</a>
            <div class="float-left">
                <input type="text" id="searchBox" data-model="rotary" class="form-control mb-3 float-right"
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.pagination a', function(e) {
                ...
                fetchData(inputElement, page, 'rotary');
            });

            $('#searchBox').each(function() {
                fetchData(this, 1, 'rotary');
            });
        });
    </script>
@stop
