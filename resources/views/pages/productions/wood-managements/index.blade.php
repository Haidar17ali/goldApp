...
@section('title', 'Pengelolaan Kayu ', $type)
...
@section('content')
    <div class="card">
        <div class="card-header">
            ...
            <a href="{{ route('pengelolaan-kayu.buat', $type) }}" class="btn btn-primary float-right"><i
                    class="fas fa-plus"></i>
                Pengelolaan Kayu {{ $type }}</a>
            <div class="float-left">
                <input type="text" id="searchBox" data-model="wood-management" class="form-control mb-3 float-right"
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.pagination a', function(e) {
                ...
                fetchData(inputElement, page, 'wood-management');
            });

            $('#searchBox').each(function() {
                fetchData(this, 1, 'wood-management');
            });
        });
    </script>
@stop
